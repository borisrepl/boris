...
class Autocompletion
{
    ...
    private function getSymbols()
    {
        if (empty($this->symbols)) {
            $this->symbols = call_user_func_array("array_merge", array_values(get_defined_functions()));
            
            $this->symbols = array_merge($this->symbols, array_keys(get_defined_constants()));
        }
